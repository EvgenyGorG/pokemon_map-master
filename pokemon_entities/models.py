...
class Pokemon(models.Model):
    ...
    title_en = models.CharField("имя покемона на английском", max_length=200, null=True, blank=True)
    title_jp = models.CharField("имя покемона на японском", max_length=200, null=True, blank=True)
